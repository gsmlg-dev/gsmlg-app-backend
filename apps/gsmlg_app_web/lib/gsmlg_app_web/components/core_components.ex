defmodule GsmlgAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GsmlgAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GsmlgAppWeb.Gettext, "errors", msg, opts)
    end
  end
